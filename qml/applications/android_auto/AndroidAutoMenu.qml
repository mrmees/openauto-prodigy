...
Item {
    ...
    Repeater {
        ...
        delegate: Item {
            ...
            readonly property real videoW: contentAspect > displayAspect ? androidAutoMenu.width : androidAutoMenu.height * contentAspect
            readonly property real videoH: contentAspect > displayAspect ? androidAutoMenu.width / contentAspect : androidAutoMenu.height
    ...
    ColumnLayout {
        ...
        Text {
            ...
            Layout.maximumWidth: androidAutoMenu.width * 0.8
        }
