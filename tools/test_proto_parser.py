...
def test_parse_message():
    ...
    result = parse_proto_file("libs/prodigy-oaa-protocol/proto/oaa/audio/AudioConfigData.proto")
...
def test_parse_enum():
    ...
    result = parse_proto_file("libs/prodigy-oaa-protocol/proto/oaa/common/StatusEnum.proto")
...
def test_parse_repeated():
    ...
    result = parse_proto_file("libs/prodigy-oaa-protocol/proto/oaa/input/InputChannelData.proto")
...
def test_parse_packed():
    ...
    result = parse_proto_file("libs/prodigy-oaa-protocol/proto/oaa/bluetooth/BluetoothChannelData.proto")
...
def test_parse_oneof_fields():
    ...
    result = parse_proto_file("libs/prodigy-oaa-protocol/proto/oaa/control/ConnectionConfigurationData.proto")
