...
**Date:** 2026-07-05
**Status:** DESIGNED — implementation deferred to executors (plans: `docs/superpowers/plans/2026-07-05-multi-dashboards-implementation.md`, `docs/superpowers/plans/2026-07-05-overlay-framework-implementation.md`).
