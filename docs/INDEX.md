...
- [aa-phone-side-debug.md](aa-protocol/aa-phone-side-debug.md) — dated phone-side capture with a current GAL-correction note (use the runbook for current commands)
...
- [aa-display-rendering.md](aa-protocol/aa-display-rendering.md) — video pipeline, rendering, and current GAL/field-11 CLUSTER-lab policy
