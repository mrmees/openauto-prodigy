...
### v0.4.1 Audio Equalizer (Complete — 2026-03-02)
...
- [x] **Phase 1: DSP Core** - RT-safe 10-band biquad engine with coefficient interpolation, bypass, and unit tests
- [x] **Phase 2: Service & Config** - EqualizerService with presets, per-stream profiles, AudioService integration, YAML persistence
- [x] **Phase 3: Head Unit EQ UI** - Touch-friendly QML interface with sliders, preset picker, and stream selector
...
| 2. Service & Config | 2/2 | Complete | 2026-03-02 |
| 3. Head Unit EQ UI | 2/2 | Complete | 2026-03-02 |

---
*Roadmap created: 2026-03-01*
*Last updated: 2026-03-02 — Milestone complete, all phases verified*
