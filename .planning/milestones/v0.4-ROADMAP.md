# Roadmap: OpenAuto Prodigy v0.4

## Overview

Logging foundations and visual personalization. Quiet-by-default logging with debug toggles, then user-selectable color palettes, wallpapers, and brightness control.
