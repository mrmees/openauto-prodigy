...
Plans:
- [x] 04-01-PLAN.md -- Qt 6.8 upgrade on dev VM + QT_VERSION guard removal
- [x] 04-02-PLAN.md -- M3 button components (ElevatedButton, FilledButton, OutlinedButton)
- [x] 04-03-PLAN.md -- Migrate control components (Tile, SettingsListItem, SegmentedButton, FullScreenPicker, ConnectionSettings)
- [x] 04-04-PLAN.md -- Navbar gradient fade + power menu buttons + barShadow removal + Pi verification
- [x] 04-05-PLAN.md -- Dialog/popup button migration + panel elevation (Level 3)
