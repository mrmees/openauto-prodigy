...
- [ ] **Phase 19: Widget Instance Config** - Per-placement config storage, config UI, and persistence
...
**Success Criteria** (what must be TRUE):
  ...
  2. User can open a config UI from the widget context menu and change settings
...
- [ ] 19-02: Widget config UI via context menu
...
|-------|----------------|--------|-----------|
| 19. Widget Instance Config | 0/2 | Not started | - |
| 20. Simple Widgets | 0/2 | Not started | - |
